...
//search
         ...
         this.spacerButtom = new SeparatorBox(this.showSpacerLine, this.spacerSize);
   ...
   loadDragon: function() {
      ...
      this.operativePanel.add(this.spacerButtom.actor, {x_fill: true, y_fill: true, y_align: St.Align.START, expand: true});
