...
Last version release date: 31 March 2014
***
...
0.9-Beta
   ...
   - Added the feature to Highlight newly installed apps.
   - Added the code to call cinnamon-remove-application to be used if this work well.
